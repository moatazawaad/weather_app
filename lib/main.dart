...
import 'package:weather_app_clean_arch/test_singleton-pattern/test_singleton_pattern.dart';
import 'package:weather_app_clean_arch/weather/data/datasources/remote_datasource.dart';
import 'package:weather_app_clean_arch/weather/data/repository/weather_repository.dart';
...
import 'package:weather_app_clean_arch/weather/domain/usercases/get_weather_by_country.dart';
...
void main() async {
  ...
  print(weather);
// دا كدا لو عاوز تشغل كونستركتور العادى
  // var singleton = MySingleton();

  //ودول لو عاوز تشغل انستنس والسنجلتون النيمد كونستراكتور
  var t2 = MySingleton.instance;
  var test = MySingleton.instance;
  runApp(const MyApp());
}
